...
function populateStates(countryElementId, stateElementId) {
    ...
    var selectedCountryIndex = document.querySelector(countryElementId).selectedIndex;

    var stateElement = document.querySelector(stateElementId);
...
function populateCountries(countryElementId, stateElementId) {
    ...
    var countryElement = document.querySelector(countryElementId);
...
jQuery(function() {
    jQuery(window).on('load', function () {
        ...
        populateCountries(country_class, state_class);
